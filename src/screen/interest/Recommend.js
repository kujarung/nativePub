    ...
    <View  style={common.contentCon}>
      <View style={interest.cardContainer}>
        <TouchableOpacity style={interest.innerCard}>
          <Image source={rectangle} style={[interest.innerImage, {marginRight: 10}]}/>
          <View style={{flex: 1}}>
            ...
            <Text style={[ {flexWrap: 'wrap'} ,common.fontBold, common.h6 ]} numberOfLines={2} ellipsizeMode={'tail'}>
              At least 50 At leastAt least 50 At leastAt least 50 At leastAt least 50 At leastAt least 50 At leastAt least 50 At leastAt least 50 At leastAt least 50 At leastAt least 50 At leastAt least 50 At least
            </Text>
          </View>
        </TouchableOpacity>
        <ScrollView horizontal style={interest.bottomCard}>
          <View>
            <Text style={interest.bottomTxt}>
              #bio
            </Text>
          </View>
          <View>
    ...
    <View style={common.stackWidthContainer}>
      <ScrollView>
        <View style={[common.contentCon, {marginTop: 22}]}>
          <Text style={[common.h2, {marginBottom: 25}]}>
            Result
          </Text>
          ...
          <View style={{marginBottom: 25}}>
            <Text style={[common.h6, common.fontThin]}>
              ...
              닉네임님께서 <Text style={common.fontBold}>좋아하실 만한 학습 콘텐츠</Text>를 골라봤어요. {"\n"}
        ...
        <View style={[common.contentCon]}>
          <View style={[common.textBox, {marginBottom: 30}]}>
            ...
            <Text style={[common.h6, common.fontThin]}>
              혹시 마음에 들지 않으세요?{"\n"}
              그렇다면 <Text style={common.fontBold}>홈 화면</Text>에서 매일 업데이트 되는{"\n"}
              다양한 콘텐츠를 <Text style={common.fontBold}>직접 골라보세요.</Text>
            </Text>           
          </View>
