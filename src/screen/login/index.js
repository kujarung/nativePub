...
import { naverBtn, kakaoBtn, fbBtn, googleBtn } from 'assets/styleSheet/imageUtils';
      ...
      <View style={sign.bttomContainer}>
        ...
        <View style={{marginBottom: 33}}>
          <Text style={[common.h6, common.fontThin]}>
            ...
            장벽을 뛰어 넘는 <Text style={common.fontBold}>리딩퍼센트</Text>에 초대합니다.
          </Text>
        </View>        
        <TouchableOpacity style={[btn.btn, btn.backgruondNaverBtn, {marginBottom: 16}]}>
        ...
        <TouchableOpacity style={[btn.btn, btn.backgruondKakaoBtn, {marginBottom: 16}]}>
        ...
        <TouchableOpacity style={[btn.btn, btn.backgruondFbBtn, {marginBottom: 16}]}>
        ...
        <TouchableOpacity style={[btn.btn, btn.backgruondGoogleBtn, {marginBottom: 16}]}>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'center'}}>
          <Text style={common.h7}>
            아직 리딩퍼센트의 회원이 아니신가요?
          </Text>
          <TouchableOpacity> 
            <Text style={[common.primaryEmasis, {marginLeft: 5}]}>먼저 둘러보기</Text> 
          </TouchableOpacity>
        </View>                 
      </View>
