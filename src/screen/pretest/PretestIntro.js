        ...
        <ModalContent>
          <View style={[popup.popupContainer, {marginBottom: 43}]}>
            ...
            <Text style={[common.h6, common.fontThin]}>
              ...
              리딩퍼센트에 합류하신 것을 진심으로 <Text style={common.fontBold}>환영합니다.</Text> :)  {"\n"}
              장벽을 무너뜨리는 그 날까지 <Text style={common.fontBold}>함께</Text>해요!  {"\n"}
            </Text>
            <View>
            <Text style={[common.h6, common.fontThin, {marginBottom: 30}]}>
              <Text style={common.fontBold}>어떤 콘텐츠</Text> 로 시작하면 좋을까요?{"\n"}
              학습 효과가 좋고 <Text style={common.fontBold}>관심사</Text>와 <Text style={common.fontBold}>흥미</Text>에 맞는 {"\n"}
              콘텐츠가 좋을 것 같아요.{"\n"}
              {"\n"}
              편한 마음으로 <Text style={common.fontBold}>퀴즈</Text>를 풀어 주세요!                
            </Text>
            </View>
          </View>
          <BtnPrimaryBac btnTxt={'시작하기'} onPress={ onPress }/>
          <TouchableOpacity style={{marginTop: 10}} onPress={() => console.log('press')}>
