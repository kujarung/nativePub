...
export const Intro2 = () => {
  ...
  return (
    <ScrollView>
      ...
      <View style={[intro.bottomCard, {marginBottom: 30, marginTop: 50}]}>
        ...
        <View style={{marginBottom: 30}}>
          <ProgressCircle style={{ height: 250 }} progress={0.6} progressColor={color.primary} />
        ...
        <View>
          ...
          <Text style={[common.h4, common.fontBold, {letterSpacing: -0.9}]}>
            당신은 몇 퍼센트가 되고 싶나요?
          </Text>
        </View>
      </View>

      <TouchableOpacity onPress={press} style={[common.contentCon, {marginBottom: 30}]}>
